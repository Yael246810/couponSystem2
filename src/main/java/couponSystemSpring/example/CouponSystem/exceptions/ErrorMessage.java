...
public enum ErrorMessage {
    ...
    UPDATE_COUPON_CANNOT_UPDATE_DATE("cannot update because end date is before start date"),
    UPDATE_COUPON_DATE_NOT_VALID("end date expired"),
    ...
    CANNOT_ADD_COUPON_DATE_NOT_VALID("end date is before start date"),

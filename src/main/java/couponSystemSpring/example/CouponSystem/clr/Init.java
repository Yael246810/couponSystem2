...
public class Init implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Coupon coupon2 = Coupon.builder()
                ...
                .title("Shein - 20% off")
                .description("Get 20% off on all orders over 200$")
                .startDate(startDate)
                .endDate(endDate)
                .amount(500)
                .price(50)
        ...
        Coupon coupon5 = Coupon.builder()
                ...
                .title("Zimmer - $5 off")
                .description("Get $5 off on all hotel bookings")
                .startDate(startDate)
                .endDate(endDate)
                .amount(200)
                .price(500.00)
        ...
        Coupon coupon6 = Coupon.builder()
                ...
                .category(Category.CLOTHING)
                .title("Castro - 10% off")
                .description("Get 10% off on the new collection")
                .startDate(startDate)
                .endDate(endDate)
                .amount(500)
                .price(100.00)
        ...
        Coupon coupon7 = Coupon.builder()
                ...
                .title("MoonActive-100 free")
                .description("Get 100 free spins on Coin Master")
                .startDate(startDate)
                .endDate(endDate)
                .amount(1000)
                .price(10.00)
        ...
        Coupon coupon8 = Coupon.builder()
                ...
                .category(Category.FOOD)
                .title("Coca Cola")
                .description("Buy one Cola and get one for free")
        ...
        Coupon coupon9 = Coupon.builder()
                ...
                .title("Ivory - 20% off")
                .description("Get 20% discount on all Ivory laptops")
                .startDate(startDate)
                .endDate(endDate)
                .amount(100)
                .price(40.00)
        ...
        Coupon coupon10 = Coupon.builder()
                .company(company10)
                .category(Category.ELECTRONICS)
                .title("Intel - Get 10% off")
                .description("Upgrade your PC and get 10% discount")
                .startDate(startDate)
                .endDate(endDate)
                .amount(50)
                .price(45.00)
